...
export default function NavBar(){
    return(
        <nav className="bg-green w-full h-fit py-4 fixed bottom-0 left-0 px-5 flex flex-col items-center z-10 md:top-0 md:bg-white md:flex-row md:justify-between md:p-5 md:px-8">
            <p className="font-bold text-xl hidden md:block">ORGANIZE</p>
            <ul className="hidden md:flex list-none">
                <li className="text-text font-bold nav-links-desk mx-2"><Link href="/">Home</Link></li>
                <li className="text-text font-bold nav-links-desk mx-2"><Link href="/">Sobre Nosotros</Link></li>
                <li className="text-text font-bold nav-links-desk mx-2"><Link href="/">¿Qué es?</Link></li>
                <li className="text-text font-bold nav-links-desk mx-2"><Link href="/">Funcionalidades</Link></li>
                <li className="text-text font-bold nav-links-desk mx-2"><Link href="/">¡¡Colabora!!</Link></li>
            </ul>
